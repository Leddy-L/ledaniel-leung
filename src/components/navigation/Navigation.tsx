...
function Navigation() {
  ...
  return (
    <div>
      <Navbar fluid className="fixed top-0 min-w-full bg-zinc-900 h-16 border-b border-zinc-600 shadow-xl p-3 z-50">
        <Navbar.Brand href="#">
          <Avatar alt="avatar of LeDaniel" img={avatar} placeholderInitials="LL" size="md" rounded>
            <div className="text-zinc-200">
              <div className="font-bold md:text">LeDaniel Leung</div>
