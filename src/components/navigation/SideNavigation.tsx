...
const SideNavigation = ({
    showSideNavigation,
    handleSideNavigationClose,
}: {
    showSideNavigation: boolean
    handleSideNavigationClose: () => void
}) => {
    const navItems = [
        {
            id: 0,
    ...
    return (
        <Drawer
            ...
            backdrop={!isViewportLargerThanMedium()}
            aria-label="sidebar"
            className="bg-zinc-900 shadow-xl mt-16 border-r border-zinc-600 md:w-1/5 md:-translate-x-0 "
        >
